...
internal fun Meal.toMealFavoriteEntityDomainModel() = MealFavoriteEntity(
...
fun List<MealFavoriteEntity>.toListMealFavoriteDomainModel() = mapNotNull {
    try {
        it.toMealFavoriteDomainModel()
    } catch (e: Exception) {
        null
    }
}

internal fun MealFavoriteEntity.toMealFavoriteDomainModel() = Meal(
    idMeal = idMeal.orEmpty(),
    strMeal = strMeal.orEmpty(),
    strDrinkAlternate = strDrinkAlternate.orEmpty(),
    strCategory = strCategory.orEmpty(),
