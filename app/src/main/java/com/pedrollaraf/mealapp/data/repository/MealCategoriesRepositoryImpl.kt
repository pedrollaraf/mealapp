...
import com.pedrollaraf.mealapp.data.datasource.mappers.toListMealCategoryDomainModel
...
class MealCategoriesRepositoryImpl(
    ...
    override suspend fun getMealCategories(): List<MealCategory> {
        return mealCategoriesRemoteDataSource.getMealCategories().toListMealCategoryDomainModel()
    }
}